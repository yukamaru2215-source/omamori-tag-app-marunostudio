...
<button onClick={() => router.push('/admin/tags')} className="text-sm text-[#1A6640] border border-[#B2D8C0] px-3 py-2 rounded-xl bg-[#E6F4EC] font-bold">🏷️ タグ発行</button>
<button onClick={() => window.open('/admin/card', '_blank')} className="text-sm text-[#1A6640] border border-[#B2D8C0] px-3 py-2 rounded-xl bg-[#E6F4EC] font-bold">📇 封入カード</button>
<button onClick={() => window.open('/admin/package-label', '_blank')} className="text-sm text-[#1A6640] border border-[#B2D8C0] px-3 py-2 rounded-xl bg-[#E6F4EC] font-bold">📦 パッケージラベル</button>
