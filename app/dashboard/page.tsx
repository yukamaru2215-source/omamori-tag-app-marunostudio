  ...
  return (
    <main className="min-h-screen bg-[#F4F7F5] p-4">
      <div className="max-w-md mx-auto">
        <div className="flex justify-between items-center mb-6 text-[#0E1A12]">
        ...
        <div className="space-y-4">
          {children.map(child => (
            <div key={child.id} className="bg-white p-4 rounded-2xl border border-[#E0EAE2] shadow-sm text-[#0E1A12]">
