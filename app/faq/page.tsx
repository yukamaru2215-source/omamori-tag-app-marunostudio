...
const FAQS = [
  {
    ...
    items: [
      ...
      {
        q: '複数人に使えますか？',
        a: 'はい。1つのアカウントで複数人を登録できます。それぞれに個別のタグを用意するだけです。',
      },
    ],
  },
  {
    ...
    items: [
      {
        q: '誰でも情報を見られますか？',
        a: 'タグをかざすと名前・アレルギー・血液型など基本的な健康情報が表示されます。緊急連絡先・持薬・かかりつけ医などの詳細情報は、認証されたスタッフのみ閲覧できます。',
      },
      {
        q: '登録した情報は安全に管理されますか？',
      ...
      {
        q: 'スタッフが認証した後、いつまで詳細情報を見られますか？',
        a: 'スタッフ認証後は30分間操作がない場合、自動的に認証が解除されます（オートロック）。操作を続けている間は30分ずつ延長されます。認証が切れると詳細情報は非表示に戻り、再度NFCタグとPINによる認証が必要になります。',
      },
      {
        q: 'タグを紛失したらどうなりますか？',
      ...
      },
      {
        ...
        a: '紛失モードが有効になっている場合、タグのURLにアクセスすると「このタグは現在無効化されています」と表示され、登録された情報は何も見えません。かわりに「発見を知らせる」ボタンが表示され、押すと登録者のメールに通知が届きます。個人情報は表示されないまま、持ち主への連絡が取れる設計です。',
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        q: '保護者への緊急通知とはなんですか？',
        a: 'タグをスキャンした方が「緊急通知を送る」ボタンを押すと、登録された連絡先のメールアドレスに通知が届きます。発見者の位置情報も合わせて送信されます（位置情報の取得に同意した場合）。',
      },
    ],
  },
  {
