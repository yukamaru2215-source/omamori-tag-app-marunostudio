...
export default function GuidePage() {
  ...
  .guide-visual__topbar{
    max-width:1040px;margin:0 auto;padding:24px 24px 0;
  ...
  .guide-visual__print{
    font-size:12.5px;font-weight:700;color:var(--accent-ink,#0F4A2C);
    text-decoration:none;border:1px solid var(--line);border-radius:10px;
    padding:8px 14px;background:var(--panel);white-space:nowrap;
  }
  .guide-visual__print:hover{background:var(--accent-soft);}
  ...
  @media (max-width:640px){.closing{grid-template-columns:1fr;}}
      ...
      <div className="guide-visual__topbar">
        <Link href="/" className="guide-visual__back">← トップへ戻る</Link>
        <Link href="/guide/print" className="guide-visual__print">🖨️ A4で印刷する</Link>
      </div>
